    ...
    <div className="min-h-screen flex flex-col bg-gray-100 relative">
      ...
      <div className="bg-white m-5 p-5 rounded-lg border border-gray-200">
        <div className="mb-4">
          ...
          <div className="flex justify-between items-center">
            ...
            <Button
              ...
              onClick={() => handleCopy("6800", "Amount")}
            >
              <Copy size={18} />
              Copy
            </Button>
        ...
        <div className="mb-4 border-t pt-4">
          ...
          <div className="flex justify-between items-center">
            <p className="text-2xl font-bold">0955367760</p>
            <Button
              variant="default"
              className="bg-blue-600 hover:bg-blue-700 flex items-center gap-2"
              onClick={() => handleCopy("0955367760", "Account Number")}
            >
              <Copy size={18} />
              Copy
            </Button>
        ...
        <div className="mb-4 border-t pt-4">
          ...
          <p className="text-2xl font-bold">SMART CASH</p>
        </div>

        <div className="mb-4 border-t pt-4">
          <p className="text-gray-500 text-sm">Account Name</p>
          <p className="text-2xl font-bold">GOLDEN THERESA OPARA</p>
        </div>
      </div>
